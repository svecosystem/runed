    ...
    it('returns issues for invalid number, array, and object inputs', () => {
        ...
        expect((invalidResult as any).issues).toEqual(
            expect.arrayContaining([
                expect.objectContaining({ message: expect.stringContaining('Invalid number'), path: ['bar'] }),
                expect.objectContaining({ message: expect.stringContaining('Invalid array'), path: ['baz'] }),
                expect.objectContaining({ message: expect.stringContaining('Invalid object'), path: ['qux'] })
            ])
        );
    });
