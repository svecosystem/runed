...
export const alertVariants = tv({
	...
	variants: {
		variant: {
			...
			danger:
				"border-rose-600 bg-rose-200 text-foreground dark:border-rose-600 dark:bg-rose-500/20 [&>h5]:text-red-800 dark:[&>h5]:text-red-300 [&>svg]:text-red-800 dark:[&>svg]:text-red-300",
